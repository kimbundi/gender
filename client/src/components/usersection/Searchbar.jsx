...
const Searchbar = ({data}) => {
  ...
  return (
      ...
      <img src={assets.search} alt=""  className=' search  md:w-auto
      px-3'   />
      <input onChange={e=>setInput(e.target.value) } value={input}
       type="text" placeholder='Enter your location to find nearby support'  className='w-full h-full outline-none  text-gray-500/80' />
